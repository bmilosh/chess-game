...
class Bishop(Piece):
    ...
    def move(self, square_from: str, square_to: str, kings_positions: list[tuple],
        ...
        # print(f"bishop legal moves: {self.legal_moves=}")
        # print(f"Valid bishop move = {move_valid}")
        ...
        if move_valid:
            ...
            if queen_move is not None:
                queen_move._check_opposing_king(kings_positions[king_idx ^ 1], king_under_check,
