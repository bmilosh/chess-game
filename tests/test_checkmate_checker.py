...
class TestCheckmateChecker(unittest.TestCase):
    ...
    def test_should_verify_checkmate(self):
        ...
        is_chkmate = cmate_getter.is_checkmate(
            king, checking_pieces, b.white_active_pieces, kp, kuc, "white", b.board, b.black_active_pieces)
        ...
        king = b.board[7][4]
        is_chkmate = cmate_getter.is_checkmate(
            king, checking_pieces, b.black_active_pieces, kp, kuc, "black", b.board, b.white_active_pieces)
        ...
        is_chkmate = cmate_getter.is_checkmate(
            king, checking_pieces, b.white_active_pieces, kp, kuc, "black", b.board, b.white_active_pieces)
        self.assertEqual(False, is_chkmate)
