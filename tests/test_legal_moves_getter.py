...
class TestLegalMovesGetter(unittest.TestCase):
    ...
    def test_should_get_legal_rook_moves(self):
        ...
        lgm = lgm_getter.get_rook_legal_moves(
            b.board[0][0], kp, checking_pieces)
        self.assertEqual([], lgm)

        b.board[4][3] = Rook("white")
        b.board[4][3].rank, b.board[4][3].file = 4, 3
        lgm = lgm_getter.get_rook_legal_moves(
            b.board[4][3], kp, checking_pieces)
        true_moves = {(5, 3), (6, 3), (3, 3), (2, 3), (4, 4),
                      (4, 5), (4, 6), (4, 7), (4, 2), (4, 1), (4, 0)}
    ...
    def test_should_get_legal_bishop_moves(self):
        ...
        b.board[4][3].rank, b.board[4][3].file = 4, 3
        lgm = lgm_getter.get_bishop_legal_moves(
            b.board[4][3], kp, checking_pieces)
        true_moves = {(5, 4), (6, 5), (5, 2), (6, 1),
                      (3, 2), (2, 1), (3, 4), (2, 5)}
        self.assertEqual(true_moves, set(lgm))
    ...
    def test_should_get_legal_queen_moves(self):
        ...
        b.board[4][3].rank, b.board[4][3].file = 4, 3
        lgm = lgm_getter.get_queen_legal_moves(
            b.board[4][3], kp, checking_pieces)
    ...
    def test_should_get_legal_knight_moves(self):
        ...
        lgm = lgm_getter.get_knight_legal_moves(
            b.board[0][1], kp, checking_pieces)
        ...
        lgm = lgm_getter.get_knight_legal_moves(
            b.board[4][5], kp, checking_pieces)
