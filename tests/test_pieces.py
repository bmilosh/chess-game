...
class TestMovements(unittest.TestCase):
    ...
    def test_should_check_piece_movement_knight(self):
        ...
        move = knight.move(
            "b8", "a3", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        ...
        move = knight.move(
            "b8", "a6", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = knight.move(
            "g1", "f3", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = knight.move(
            "f3", "d4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        self.assertEqual(2, knight.rank)
        self.assertEqual(5, knight.file)
        ...
        move = knight.move(
            "b1", "a3", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        self.assertEqual(2, knight.rank)
        self.assertEqual(0, knight.file)
        ...
        move = knight.move(
            "a3", "c4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = knight.move(
            "c4", "c5", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        self.assertEqual(3, knight.rank)
        self.assertEqual(2, knight.file)
        ...
        move = knight.move(
            "d7", "e4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
    ...
    def test_should_check_piece_movement_queen(self):
        ...
        move = queen.move(
            "e2", "e5", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = queen.move(
            "f2", "f5", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        ...
        move = queen.move(
            "e7", "e7", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        ...
        move = queen.move(
            "h4", "a4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        ...
        move = queen.move(
            "h1", "b6", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        self.assertEqual(0, queen.rank)
        self.assertEqual(7, queen.file)
        ...
        move = queen.move(
            "b1", "d3", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = queen.move(
            "g2", "e4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        self.assertEqual(3, queen.rank)
        self.assertEqual(4, queen.file)
        ...
        move = queen.move(
            "b2", "c3", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        self.assertEqual(2, queen.rank)
        ...
        move = queen.move(
            "g7", "d4", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
        self.assertEqual(6, queen.rank)
        ...
        move = b.board[5][1].move(
            "b6", "g1", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(True, move)
        ...
        move = queen.move(
            "d8", "f6", kp, kuc, b.board, sqv, checking_pieces=checking_pieces
        )
        self.assertEqual(False, move)
    ...
    def test_should_check_piece_movement_king(self):
        ...
        move = king.move(
            ...
            sqv,
            checking_pieces=checking_pieces,
            opp_active_pieces=b.black_active_pieces,
            flipped=False,
        )
        self.assertEqual(False, move)
        ...
        b.board[3][6].rank, b.board[3][6].file = 3, 6
        b.white_active_pieces.append(b.board[3][6])
        b.board[5][4] = King("black")  # e6
        b.board[5][4].rank, b.board[5][4].file = 5, 4
        king.rank, king.file = 5, 4
        move = b.board[5][4].move(
            "e6",
            "f6",
            kp,
            kuc,
            ...
            sqv,
            checking_pieces=checking_pieces,
            opp_active_pieces=b.white_active_pieces,
            flipped=False,
        )
        self.assertEqual(False, move)
        ...
        b.board[2][2].rank, b.board[2][2].file = 2, 2
        b.board[0][6] = king
        king.rank, king.file = 0, 6
        move = b.board[0][6].move(
            "g1",
            "h2",
            kp,
            kuc,
        ...
        king.rank, king.file = 6, 2
        b.board[6][2] = king
        # print(b.black_active_pieces)
        # print(*b.board, sep='\n')
        move = b.board[6][2].move(
            "c7",
            "c8",
            kp,
            kuc,
        ...
        b.board[3][5] = King("black")  # f4 King's under check from white bishop on c1
        b.board[3][5].rank, b.board[3][5].file = 3, 5
        # king.rank, king.file = 3, 5
        # print()
        # print(*b.board, sep='\n')
        move = b.board[3][5].move(
            "f4",
            "e4",
            kp,
            kuc,
        ...
        self.assertEqual(True, move)
        self.assertEqual(3, b.board[3][5].rank)
        self.assertEqual(4, b.board[3][5].file)
...
class TestCastling(unittest.TestCase):
    ...
    def test_should_check_castling_queenside(self):
        ...
        b.black_active_pieces = [p for p in b.black_active_pieces if p.name != "queen"]
        move = b.board[0][4].move(
            "e1",
            "c1",
            kp,
        ...
        b.board[0][3] = 0
        b.white_active_pieces = [p for p in b.white_active_pieces if p.name != "queen"]
        move = b.board[7][4].move(
            "e8",
            "c8",
            kp,
